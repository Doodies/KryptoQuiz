...
public class SharedPrefrencesHelper {
    ...
    private static final String SETTINGS_NAME = "kSparsApplicationPrefs";
    ...
    public static class SharedPrefsKey {
        public static final String kPrefsUser = "prefs_user";
        public static final String kAccessToken = "prefs_access_token";
        public static final String appVersionCode = "app_version";
        public static final String updateAppVersion = "update_version";
        public static final String autoStart = "auto_start";

        public static final String canCreateSellOffer = "can_create_sell_offer";
        public static final String newsSaveText = "news_text";
    }
